...
cp /usr/local/gfortran/lib/libgcc_s.2.dylib libgcc_s.2.dylib
...
install_name_tool -change /usr/local/gfortran/lib/libgcc_s.2.dylib  @executable_path/../lib/libgcc_s.2.dylib libgfortran.5.dylib
...
# libgcc_s.2.dylib
install_name_tool -id @executable_path/../lib/libgcc_s.2.dylib libgcc_s.2.dylib
...
install_name_tool -change /usr/local/gfortran/lib/libgcc_s.2.dylib  @executable_path/../lib/libgcc_s.2.dylib x13ashtml
